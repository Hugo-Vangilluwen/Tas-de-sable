...
Le modèle du tas de sable est riche puisqu'il s'applique sur sur tous les
graphes diverses et variés. Caractériser la nature du monoïde et du groupe
dessine les contours de ce modèle.
...
Soit $F \subseteq M$ et $E \in \mathcal{ME}(F)$.
$(F, E)$ est une pseudo-base de $M$ si :
\begin{enumerate}
...
\begin{corollaire}
Tout monoïde abélien admettant une pseudo-base n'est pas simplifiable.
\end{corollaire}

\begin{proof}
Un monoïde des tas de sable n'est pas simplifiable.
\end{proof}
